...
public class PaginationGenUtilTest {
    ...
    public void testGenerateCommonPagingPart() {
        ...
        String expectedResult = "<span>Total Records: 1000</span>" + PaginationGenUtil.LINE_SEPARATOR
                + "<span>page: 2/20</span>" + PaginationGenUtil.LINE_SEPARATOR + "<span>records in page: 50</span>"
    ...
    public void testGenerateSearchingParams() {
        PageBean bean = new PageBean();
        bean.addSearchingParams("param", "paramValue");
        String expectResult = "<input type=\"hidden\" name=\"param\" value=\"paramValue\" />"
                + PaginationGenUtil.LINE_SEPARATOR;
