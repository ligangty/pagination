...
public class PageBean implements Serializable {
    ...
    /**
     * Map holds the web context params which may be used to be the searching params for db
     */
    ...
    public PageBean(long totalRecords) {
        this.pageSize = DEFAULT_PAGE_SIZE;
        this.totalPage = (int) (totalRecords % pageSize == 0 ? totalRecords / pageSize : totalRecords / pageSize + 1);
    }
    ...
    public void setTotalRecords(long totalRecords) {
        ...
        setTotalPage((int) (totalRecords % getPageSize() == 0 ? totalRecords / getPageSize() : totalRecords / getPageSize() + 1));
    }
    ...
    public void addSearchingParams(String param, Object value) {
        if (!PAGE_ATTR.equals(param) && !"init".equals(param) && !TOTALRECS_ATTR.equals(param)) {
